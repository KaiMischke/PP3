...
<svg xmlns="http://www.w3.org/2000/svg"
     ...
     viewBox="-400 -300 800 600">
  <title>Sample SVG</title>
  <desc>A simple example of an SVG file structure, that shows a straight line, a circle and a rectangle.</desc>
  <g stroke="blue" >
    <line x1="100" y1="-100" x2="300" y2="-100"
            stroke-width="5"  />
  </g>
  <circle cx="105" cy="0" r="10" fill="blue" stroke="blue" />
...
<details>
    ...
    Prepended hashes create a heading. Depending on the number of prepended hashes, different levels of headings are created (e.g. # = level 1 heading, ## = level 2 heading, etc.).
</details>
<details>
    <summary>How do you mark italic or bold font?</summary>
     Bold is marked with two leading and two trailing asterisks, e.g. **bold**.
     Italic wird mit einleitenden und ausleitenden unterstrichen markiert. z .B. _italic_
    <code>
    **bold**
    _italic_
    </code>
...
<details>
    <summary>Which different ways are there to generate listings and tables?</summary>
     Listings are generated via </details> 
    <code>
    <details>
         <summary>A</summary>
     <details>
...
<details>
    ...
    The LaTeX compiler generated the following files: example.pdf.aux, example.pdf.log and example.pdf.pdf
</details>
...
<details>
    ...
    The title, the author and the date get centered. The Text _Hello, world_ is displayed on the second page.
</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
    The heading 0.1 intro is generated
</details>
...
<details>
  ...
  If we change <p>Hello, world!</p> to <h1>Hello, world!</h1> the text is displayed bold.
</details>
